 ...
 */
EDDPIN.prototype.separateUserModes = function (modeList) {
 ...
 * @returns {boolean}
 */
EDDPIN.prototype.isType_channel = function (test) {
 ...
 * @returns {boolean}
 */
EDDPIN.prototype.isType_user = function (test) {
 ...
 * @returns {boolean}
 */
EDDPIN.prototype.isType_user_strict = function (test) {
 ...
 * @returns {boolean}
 */
EDDPIN.prototype.isType_pseudouser = function (test) {
 ...
 * @returns {boolean}
 */
EDDPIN.prototype.isType_event = function (test) {
 ...
 * @returns {boolean}
 */
EDDPIN.prototype.isType_server = function (test) {
    return test instanceof this.generic.server;
};

EDDPIN.prototype.isType_module = function (test) {
